...
Mode four is the diamond scanner. It hunts for lower-priced US stocks, ten dollars a share and under, with a real, dated, verifiable catalyst within roughly 90 days, and scores each candidate on four trap checks: dated catalyst, cash runway, insider buying per SEC Form 4, and dilution history. This covers both true penny stocks under five dollars and small-caps in the five to ten range, like a small medical-device or biotech name with a pending FDA or earnings event.
